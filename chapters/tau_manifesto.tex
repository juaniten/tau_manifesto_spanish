...
Comencemos a reparar el daño que ha provocado $\pi$ tratando de comprender en primer lugar el famoso número en sí. La definición tradicional para la constante de la circunferencia establece que $\pi$ (pi) es la razón entre el perímetro de una circunferencia y su diámetro\footnote{El símbolo $\equiv$ significa ``se define como''.}:
\begin{equation}
\label{eq:pi}
...
\begin{equation}
\label{eq:lhopital}
A = \splim{n\rightarrow\infty} \frac{1}{2} n\, \mbox{sen}\,\frac{\tau}{n}
= \frac{1}{2} \splim{n\rightarrow\infty} \frac{\mbox{sen}\,\frac{\tau}{n}}{1/n} = \tfrac{1}{2}\tau.
\end{equation}
